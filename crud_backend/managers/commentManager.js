...
async function addComment(req, res) {
    ...
    if (!postId) {
        return sendErrResp(res, statusCodes.BAD_REQUEST, errorCodes.BAD_REQUEST, "postId missing");
    }
    if (!userId) {
        return sendErrResp(res, statusCodes.BAD_REQUEST, errorCodes.BAD_REQUEST, "userId missing");
    }
    if (!comment) {
        return sendErrResp(res, statusCodes.BAD_REQUEST, errorCodes.BAD_REQUEST, "comment missing");
    }
...
async function addReply(req, res) {
    ...
    if (!parentId) {
        return sendErrResp(res, statusCodes.BAD_REQUEST, errorCodes.BAD_REQUEST, "parentId missing");
    }
